  ...
  factory CompleteProfileResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (root['data'] is Map<String, dynamic>) {
      ...
      if (data['profile'] is Map<String, dynamic>) {
        ...
        final profileJson = (profileContainer['profile'] is Map<String, dynamic>)
        ...
        return CompleteProfileResponseModel(
          profile: profileJson != null ? ProfileModel.fromJson(profileJson as Map<String, dynamic>) : null,
          updatedUser: updatedUserJson != null && updatedUserJson is Map<String, dynamic>
              ? UpdatedUserModel.fromJson(updatedUserJson as Map<String, dynamic>)
              : null,
        );
      }
      ...
      return CompleteProfileResponseModel(
        profile: ProfileModel.fromJson(data as Map<String, dynamic>),
        updatedUser: null,
      );
    }
    ...
    if (root['profile'] is Map<String, dynamic>) {
      return CompleteProfileResponseModel(
        ...
        updatedUser: (root['updatedUser'] is Map<String, dynamic>)
            ? UpdatedUserModel.fromJson(root['updatedUser'] as Map<String, dynamic>)
            : null,
      );
    }
