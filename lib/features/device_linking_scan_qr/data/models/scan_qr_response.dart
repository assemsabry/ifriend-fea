class ScanQrResponse {
  ...
  factory ScanQrResponse.fromJson(Map<String, dynamic> json) {
    ...
    return ScanQrResponse(
      ...
      child: data != null && data['child'] != null && data['child'] is Map<String, dynamic>
      ...
      batteryPercentage: data != null ? (data['batteryPercentage'] is int ? data['batteryPercentage'] as int : (int.tryParse('${data['batteryPercentage']}')) ) : null,
