...
import 'package:ifriend_app/features/device_management/presentation/bloc/device_management_event.dart';
import 'package:ifriend_app/features/device_management/presentation/bloc/device_management_state.dart';
import 'package:ifriend_app/core/routing/routes.dart';

class ChildsDevicesScreen extends StatelessWidget {
  const ChildsDevicesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          di.sl<DeviceManagementBloc>()..add(const LoadLinkedDevices()),
      child: const _ChildsDevicesContent(),
    );
  }
}

class _ChildsDevicesContent extends StatelessWidget {
  const _ChildsDevicesContent();
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    context
                        ...
                        .add(RemoveDevice(device.userId!));
                  },
                  child: Text(
                    'Remove Device',
                    style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<DeviceManagementBloc, DeviceManagementState>(
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _DeviceCard(
                        device: device,
                        onRemove: () => _showRemoveDeviceDialog(context, device),
                      );
                    },
                  ),
                ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context)
                            .pushNamed(Routes.deviceLinkingScanQrScreen);
                      },
                      child: Text(
                        'Add new devices',
                        style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          // Avatar
          if (device.childAvatar != null && device.childAvatar!.isNotEmpty)
            ClipRRect(
