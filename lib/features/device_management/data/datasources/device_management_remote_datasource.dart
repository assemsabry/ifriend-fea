...
import 'package:ifriend_app/features/device_management/data/models/linked_device.dart';
  ...
  Future<List<LinkedDevice>> getLinkedDevices() async {
    try {
      ...
      if (e.response?.statusCode == 404 || 
        ...
        print('✅ Confirmed: NO DEVICES LINKED (404 or message contains "no linked")');
        return [];
      }
