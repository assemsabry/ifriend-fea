...
import 'package:ifriend_app/features/new/featuress/child/learn/controller/numbers/numbers_cubit.dart';
...
class NumbersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => NumbersCubit()..setupLevel(1),
      child: BlocBuilder<NumbersCubit, NumbersState>(
        builder: (context, state) {
          return Scaffold(
            extendBodyBehindAppBar: true,
            appBar: DefAppbar(
              title: "Number Lv.${state.level}",
                    ...
                    child: Column(
                      children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                AnimatedScale(
                                  ...
                                  child: AppImage(
                                    path:
                                        "assets/numbers/${state.board[state.currentIndex]}",
                                    height: 0.3.sh,
                                    fit: BoxFit.contain,
                                  ),
                                ),
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            context.read<NumbersCubit>().nextNumber();
                          },
                          child: Container(
                            width: double.infinity,
                            height: 70,
