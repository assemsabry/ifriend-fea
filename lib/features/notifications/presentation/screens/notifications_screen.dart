          ...
          Expanded(
            child: BlocBuilder<NotificationBloc, NotificationState>(
              builder: (context, state) {
                ...
                return _buildNotificationList(context, state.filteredNotifications);
              },
            ),
          ),
        ],
          ...
          child: Row(
            children: [
              _buildTabItem(
                ...
                onTap: () {
                  context.read<NotificationBloc>().add(const ChangeNotificationTab(isUnreadTab: false));
                },
              ),
              SizedBox(width: 12.w),
              _buildTabItem(
                ...
                isSelected: state.isUnreadTab,
                onTap: () {
                  context.read<NotificationBloc>().add(const ChangeNotificationTab(isUnreadTab: true));
                },
              ),
            ],
          ),
