...
// import 'package:ifriend_app/features/old/login/presentation/bloc/login_bloc.dart';
...
//             );
//             HiveHelper.addData("role", finalRole);
//             HiveHelper.addData("token", state.loginData.accessToken);
//             if (finalRole == "PARENT") {
//               HiveHelper.addData("isLinked", true);
//             }
//             HiveHelper.addData("refreshToken", state.loginData.refreshToken);
