...
import 'package:ifriend_app/features/old/device_linking_scan_qr/presentation/cubit/scan_qr_state.dart';
                  ...
                  child: SizedBox(
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () async {
                        ...
                        } else if (state is ScanQrInitial ||
                            state is ScanQrPermissionGranted) {
