...
class ResponseProfileModel {
  ResponseProfileModel({bool? success, Data? data}) {
    _success = success;
    _data = data;
  }
  ...
  bool? _success;
  Data? _data;
  ResponseProfileModel copyWith({bool? success, Data? data}) =>
      ResponseProfileModel(success: success ?? _success, data: data ?? _data);
...
class Data {
  ...
  Profile? _profile;
  Data copyWith({Profile? profile}) => Data(profile: profile ?? _profile);
...
class User {
  User({String? id, String? email, String? userType}) {
    _id = id;
    _email = email;
    _userType = userType;
  }
  ...
  String? _email;
  String? _userType;
  User copyWith({String? id, String? email, String? userType}) => User(
    id: id ?? _id,
    email: email ?? _email,
