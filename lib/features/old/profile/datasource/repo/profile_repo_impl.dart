...
import 'package:ifriend_app/features/old/profile/datasource/model/ResponseProfileModel.dart';
...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  Future<Either<ApiErrorHandler, ProfileEntity>> getParentProfile() async {
    try {
      final ResponseProfileModel model = await remoteDataSource
          .getParentProfile();
  ...
  Future<Either<ApiErrorHandler, ProfileEntity>> updateParentProfile({
    ...
    try {
      ...
      if (profileModel == null) {
        return Left(
          ApiErrorHandler(message: 'Failed to parse updated profile'),
        );
      }
