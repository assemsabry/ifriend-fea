...
import 'package:ifriend_app/features/old/login/data/datasources/login_api_service.dart';
import 'package:ifriend_app/features/old/login/data/repositories/login_repository_impl.dart';
...
import 'package:ifriend_app/features/old/device_management/data/datasources/device_management_remote_datasource.dart';
import 'package:ifriend_app/features/old/device_management/data/repositories/device_management_repository_impl.dart';
...
import 'package:ifriend_app/features/old/onboarding/data/repo/onboarding_repo_impl.dart';
import 'package:ifriend_app/features/old/permissions/data/services/permission_service.dart';
import 'package:ifriend_app/features/old/permissions/presentation/bloc/permission_bloc.dart';
import 'package:ifriend_app/features/old/device_link/data/datasources/link_api_service.dart';
import 'package:ifriend_app/features/old/device_link/data/repositories/link_repository_impl.dart';
import 'package:ifriend_app/features/old/device_link/domain/repositories/device_repository.dart';
import 'package:ifriend_app/features/old/device_link/domain/usecases/generate_child_qr_use_case.dart';
import 'package:ifriend_app/features/old/device_link/presentation/bloc/device_link_bloc.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:ifriend_app/features/old/notifications/data/sources/notification_api_service.dart';
import 'package:ifriend_app/features/old/notifications/data/repos/notification_repository_impl.dart';
import 'package:ifriend_app/features/old/notifications/domain/repos/notification_repository.dart';
import 'package:ifriend_app/features/old/notifications/domain/usecases/get_notifications_usecase.dart';
import 'package:ifriend_app/features/old/notifications/domain/usecases/mark_notification_read_usecase.dart';
import 'package:ifriend_app/features/old/notifications/domain/usecases/mark_all_notifications_read_usecase.dart';
import 'package:ifriend_app/features/old/notifications/presentation/bloc/notification_bloc.dart';

import 'package:ifriend_app/features/old/complete_profile/data/dataSource/complete_profile_data_remote.dart';
import 'package:ifriend_app/features/old/complete_profile/data/repo/complete_profile_repo_impl.dart';
...
import 'package:ifriend_app/features/old/home_layout/presentation/cubit/home_layout_cubit.dart';

import '../../features/old/complete_profile/presentation/manager/complete_profile_cubit.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/data/datasources/scan_qr_data_remote.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/data/repositories/scan_qr_repo_impl.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/domain/repository/scan_qr_repo.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/domain/usecases/scan_qr_usecase.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/domain/usecases/confirm_link_usecase.dart';
import 'package:ifriend_app/features/old/device_linking_scan_qr/presentation/cubit/scan_qr_cubit.dart';
import 'package:ifriend_app/features/old/onboarding/presentation/cubit/onboarding_cubit.dart';

import '../../features/old/login/domain/usecases/register_device.dart';
import '../../features/old/onboarding/data/domain/usecases/get_onboarding_seen.dart';
import '../../features/old/onboarding/data/domain/usecases/set_onboarding_seen.dart';
import 'package:ifriend_app/features/old/profile/datasource/data/data_profile_remote.dart';
import 'package:ifriend_app/features/old/profile/datasource/repo/profile_repo_impl.dart';
import 'package:ifriend_app/features/old/profile/domain/repo/profile_repo.dart';
import 'package:ifriend_app/features/old/profile/domain/usecases/get_profile_usecase.dart';
import 'package:ifriend_app/features/old/profile/domain/usecases/update_profile_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory<OnboardingCubit>(
    () => OnboardingCubit(getOnboardingSeen: sl(), setOnboardingSeen: sl()),
  );
  ...
  sl.registerLazySingleton<ScanQrRemoteDataSource>(
    () => ScanQrRemoteDataSource(dio: sl()),
  );

  sl.registerLazySingleton<ScanQrRepository>(
    () => ScanQrRepositoryImpl(remote: sl()),
  );
  ...
  sl.registerFactory<ChildProfileBloc>(() => ChildProfileBloc());
  ...
  sl.registerFactory<DeviceLinkBloc>(() => DeviceLinkBloc(sl()));
